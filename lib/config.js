...
export const site = {
  ...
  //
  // 🖼️  Want an image slider on a card? Add an `images` array to that project.
  //     - Put the files in the `public/` folder, e.g. public/projects/royal-1.png,
  //       then reference them from the site root: "/projects/royal-1.png".
  //     - You can also use full remote URLs (https://...).
  //     - One image = a single static picture. Two or more = a swipeable slider
  //       with arrows, dots and autoplay.
  //     - Leave `images` out (or empty) to keep the plain text-only card.
  featured: [
    {
      name: "Royal Cleaners",
    ...
    },
    {
      ...
      images: [
        "/projects/trubooker1.png"
      ],
    },

       {
      name: "True Booker Passenger",
      repo: "Urban Transport App",
      tech: ["React Native", "NestJs", "PostgreSQL", "AWS", "Android", "IOS"],
      description:
        "A Ride sharing app for Urban transport app for drivers and passengers, driver can create trip passengers book for available trips. available for Android and IOS devices",
      live: "https://play.google.com/store/apps/details?id=com.trubooker.trubooker&pcampaignid=web_share",
      images: [
        "/projects/trubooker.svg"
      ],
    },
